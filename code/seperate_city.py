...
def seperate_city(data,file='file.csv'):
    ...
    for i in range(len(city)) :
        ...
        city_arr[i].to_csv(f'{file}/test_hourly_{city[i]}.csv')
        print(f'{city[i]} has been extracted to csv format!')

if __name__ == "__main__":

    train = pd.read_csv('/Users/abilfad/Documents/CODE/weather-forecasting-datavidia/data/test.csv')
    train['time'] = pd.to_datetime(train['time'])
    train_hourly = pd.read_csv('/Users/abilfad/Documents/CODE/weather-forecasting-datavidia/data/test_hourly.csv')
    ...
    seperate_city(train_hourly,'/Users/abilfad/Documents/CODE/weather-forecasting-datavidia/data/test_hourly')
    print('Finished!')
